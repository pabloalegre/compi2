/*****************************************************************************
 Tema:    TAD LISTAs genéricas. 
 Fecha:	Octubre-94 - ezpeleta
 ...
 Uso:     Los algoritmos, detalladamente comentados, pueden encontrarse
          ...
          Hay dos tipos de operaciones de observarción e inserción:
          ...
          La LISTA genérica está implementado como una LISTA enlazada
          de NODOs. Cada NODO contiene un enlace al siguienteuiente NODO y
          un puntero genérico. Des este puntero "colgará" el dato.
*****************************************************************************/
...
/*****************************************************************************
                TIPOS
*****************************************************************************/
typedef void *ELEMENTO;         /* puntero genérico */
